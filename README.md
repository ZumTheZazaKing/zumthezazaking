...
## Current Skills
<p align="center">
		<img src="https://skillicons.dev/icons?i=html,css,js,ts,py,php,java,lua,jquery,regex,sass,tailwind,react,flask,nextjs,nodejs,webpack,materialui,firebase,git,github,netlify,md,mysql,ps,pr,vscode,visualstudio,codepen,bash,powershell,vim,bots,wordpress,godot,blender" />
</p>
